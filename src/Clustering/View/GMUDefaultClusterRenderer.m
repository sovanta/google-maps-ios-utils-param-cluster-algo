...
static const double kGMUAnimationDuration = 0.3;  // seconds.
...
- (void)clearMarkersAnimated:(NSArray<GMSMarker *> *)markers {
    ...
    for (GMSMarker *marker in markers) {
        ...
        [CATransaction setAnimationTimingFunction:[CAMediaTimingFunction functionWithControlPoints:.23 :0 :.52 :.1]];
